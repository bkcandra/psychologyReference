...
set _DeploySetParametersFile=%RootPath%ReferencingSystem.Application.Main.MVC.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%ReferencingSystem.Application.Main.MVC.zip" (
echo "%RootPath%ReferencingSystem.Application.Main.MVC.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%ReferencingSystem.Application.Main.MVC.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%ReferencingSystem.Application.Main.MVC.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%ReferencingSystem.Application.Main.MVC.deploy-readme.txt" (
...
start notepad "%RootPath%ReferencingSystem.Application.Main.MVC.deploy-readme.txt"
)
echo =========================================================
goto :eof
