    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ChangeProfilesSuccess ? "Your profiles has been updated."
                : "";

            string userId = User.Identity.GetUserId();
            var userprofile = db.UserProfiles.Where(x => x.UserId == userId).FirstOrDefault();

            var userLogins = new IndexViewModel
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (!user.Email.Equals(model.Email))
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        var templateID = db.EmailSetting.Where(x => x.EmailType == (int)SystemConstants.EmailTemplateType.UserWelcomeEmail).FirstOrDefault().EmailTemplateId; ;
                ...
                var userP = await db.UserProfiles.FindAsync(user.Id);
                ...
                return RedirectToAction("Index", "manage", new { Message = ReferencingSystem.Application.Main.MVC.Controllers.ManageController.ManageMessageId.ChangeProfilesSuccess });
            }
